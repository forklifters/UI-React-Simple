        ...
        <div>
          ...
          <div className={css.row}>
            <div className={css.main}>
              ...
              <Pagination pageActive={this.page} totalItems={totalItems} callback={this.getPage.bind(this)} type="nodes" />
            </div>
          </div>
        </div>
      </div>
...
function mapStateToProps (state, props) {
  return {
    msg: state.data.msg,
    list: state.data.nodes,
    totalItems: state.data.pagination.totalNodes,
